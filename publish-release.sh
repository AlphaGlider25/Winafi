#!/bin/bash
# Publish Winafi Beta-V0.0.5 Release

set -e

REPO="AlphaGlider25/Winafi"
TAG="Beta-V0.0.5"
APPIMAGE="Winafi-0.0.5-x86_64.AppImage"
...
echo "  gh release create $TAG -t 'Winafi Beta-V0.0.5 - Feature Complete' --notes '...' $APPIMAGE"
echo ""
