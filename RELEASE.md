...
1. **Update version in CMakeLists.txt:**
   ...
   # e.g., VERSION 0.0.5 -> VERSION 0.0.5
   ```
...
- Usage: `./Winafi-0.0.5-Beta-x86_64.AppImage`

### Debian/Ubuntu
- Install: `sudo apt install ./winafi_0.0.5_amd64.deb`
- Uninstall: `sudo apt remove winafi`

### RPM (Fedora/RHEL)
- Install: `sudo dnf install ./winafi-0.0.5-1.fc38.x86_64.rpm`
